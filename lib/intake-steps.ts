...
const QUESTIONS: Record<FlowStepKey, string> = {
  incidentType:
    "What type of incident brought you here today?",
  motorVehicleInvolvement: "Was this a multi-vehicle accident or a single-vehicle crash?",
  description: "Briefly describe what happened in your own words.",
  incidentDate: "When did this happen? An approximate date or month/year is fine.",
  incidentLocation: "Where did this happen (city and state, or as specific as you’re comfortable)?",
  injuries: "Were you physically injured?",
  medicalTreatment: "Have you seen a doctor or received any medical treatment for this?",
  otherPartyFault: "Do you believe another person or party may have been at fault?",
  policeReport: "Was a police or incident report filed?",
  hasAttorney: "Are you currently represented by an attorney for this specific matter?",
  urgent: "Do you need us to follow up within the next 24 hours?",
